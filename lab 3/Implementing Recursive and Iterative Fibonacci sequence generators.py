...
#function that determines if a given number is a Fibonacci number
import math
...
#function that calculates the ratio between consecutive Fibonacci numbers and observe how it approaches the golden ratio
